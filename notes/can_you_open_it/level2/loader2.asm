...
loader2:     file format elf64-x86-64
...
0000000000001120 <.text>:
    ...
    114e:	f4                   	hlt    
    114f:	90                   	nop
    1150:	48 8d 3d 09 2f 00 00 	lea    0x2f09(%rip),%rdi        # 4060 <exit@plt+0x2f50>
    1157:	48 8d 05 02 2f 00 00 	lea    0x2f02(%rip),%rax        # 4060 <exit@plt+0x2f50>
    ...
    1180:	48 8d 3d d9 2e 00 00 	lea    0x2ed9(%rip),%rdi        # 4060 <exit@plt+0x2f50>
    1187:	48 8d 35 d2 2e 00 00 	lea    0x2ed2(%rip),%rsi        # 4060 <exit@plt+0x2f50>
    ...
    11c4:	80 3d 95 2e 00 00 00 	cmpb   $0x0,0x2e95(%rip)        # 4060 <exit@plt+0x2f50>
    ...
    11ec:	c6 05 6d 2e 00 00 01 	movb   $0x1,0x2e6d(%rip)        # 4060 <exit@plt+0x2f50>
    11f3:	5d                   	pop    %rbp
    11f4:	c3                   	retq   
    ...
    127b:	66 c7 45 e0 08 00    	movw   $0x8,-0x20(%rbp)
